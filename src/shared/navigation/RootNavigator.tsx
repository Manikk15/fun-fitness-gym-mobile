...
import { MemberWorkoutDetailsScreen } from '../../features/members/presentation/screens/MemberWorkoutDetailsScreen';
  ...
  return (
    <NavigationContainer theme={navigationTheme}>
      <Stack.Navigator initialRouteName="Splash" screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="MemberDashboard" component={MemberNavigator} />
        <Stack.Screen
          name="MemberWorkoutDetails"
          component={MemberWorkoutDetailsScreen}
