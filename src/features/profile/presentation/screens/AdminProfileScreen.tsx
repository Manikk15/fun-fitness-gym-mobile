...
export function AdminProfileScreen() {
  const navigation =
    useNavigation<BottomTabNavigationProp<AdminTabParamList, 'Profile'>>();
    ...
    <ScreenContainer>
      <View className="flex-1 px-6 py-8">
        ...
        <View className="mt-7 rounded-3xl bg-white p-6">
          ...
          <Text className="mt-3 rounded-full bg-brand-50 px-3 py-2 text-sm font-semibold text-brand-700">
            {profile?.role}
          </Text>
        </View>
